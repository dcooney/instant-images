...
import {
	OPENVERSE_EXTENSIONS,
	OPENVERSE_LICENSES,
	OPENVERSE_ORIENTATIONS,
	OPENVERSE_SOURCES,
} from "./filters/openverse";
import { PEXELS_COLORS, PEXELS_ORIENTATIONS } from "./filters/pexels";
import {
	PIXABAY_CATS,
	PIXABAY_COLORS,
	PIXABAY_IMAGE_TYPE,
	PIXABAY_ORIENTATIONS,
} from "./filters/pixabay";
		...
		filters: {
			order_by: {
				...
				filters: [
					...
					{ label: __("Oldest", "instant-images"), value: "oldest" },
				],
			},
		},
		search: {
			order_by: {
				...
				default: "relevance",
				filters: [
					{ label: __("Relevance", "instant-images"), value: "relevance" },
					{ label: __("Latest", "instant-images"), value: "latest" },
				],
			},
			orientation: {
