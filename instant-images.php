...
define( 'INSTANT_IMAGES_RELEASE', 'November 23, 2022' );
	...
	public static function instant_img_localize( $script = 'instant-images-react' ) {
		...
		wp_localize_script(
			...
			array(
				...
				'api_invalid_msg'         => __( 'The API key is not valid for this provider - please enter a new API Key and try again.', 'instant-images' ),
				...
				'api_default_provider'    => __( 'You\'re seeing this message because the default image provider has thrown an error. Switch the Default Provider in the Instant Images settings or check the API key.', 'instant-images' ),
